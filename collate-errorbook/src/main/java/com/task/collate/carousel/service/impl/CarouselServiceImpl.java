package com.task.collate.carousel.service.impl;

import java.util.List;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import com.task.collate.carousel.mapper.CarouselMapper;
...
public class CarouselServiceImpl implements ICarouselService 
{
    ...
    @Override
    public List<Carousel> selectFrontCarouselList() {

        return carouselMapper.selectFrontCarouselList();
    }
}
